...
import ar.com.wecoode.jitws.service.ViajeTerceroCombustibleService;
...
/**
 * Clase ViajeTerceroCombustible Controller
 * @author blas
 */

@RestController
public class ViajeTerceroCombustibleController {
    
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/viajetercerocombustible";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/viajetercerocombustible";
    ...
    @Autowired
    ViajeTerceroCombustibleService elementoService;
    ...
    public ResponseEntity<?> agregar(@RequestBody ViajeTerceroCombustible elemento) {
        try {
            ViajeTerceroCombustible e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody ViajeTerceroCombustible elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody ViajeTerceroCombustible elemento) {
        try {
