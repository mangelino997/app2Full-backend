...
import ar.com.wecoode.jitws.model.TipoTarifa;
import ar.com.wecoode.jitws.service.TipoTarifaService;
...
public class TipoTarifaController {
    ...
    public ResponseEntity<?> agregar(@RequestBody TipoTarifa elemento) {
        try {
            TipoTarifa e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> eliminar(@RequestBody TipoTarifa elemento) {
        try {
