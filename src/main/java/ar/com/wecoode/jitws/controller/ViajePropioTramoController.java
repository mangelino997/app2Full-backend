...
import ar.com.wecoode.jitws.service.ViajePropioTramoService;
...
/**
 * Clase ViajePropioTramo Controller
 * @author blas
 */

@RestController
public class ViajePropioTramoController {
    
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/viajepropiotramo";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/viajepropiotramo";
    ...
    @Autowired
    ViajePropioTramoService elementoService;
    ...
    public ResponseEntity<?> agregar(@RequestBody ViajePropioTramo elemento) {
        try {
            ViajePropioTramo e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody ViajePropioTramo elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody ViajePropioTramo elemento) {
        try {
