...
import ar.com.wecoode.jitws.service.ViajeTipoService;
...
public class ViajeTipoController {
    ...
    public ResponseEntity<?> agregar(@RequestBody ViajeTipo elemento) {
        try {
            ViajeTipo e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> eliminar(@RequestBody ViajeTipo elemento) {
        try {
