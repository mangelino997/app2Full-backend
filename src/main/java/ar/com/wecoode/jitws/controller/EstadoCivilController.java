...
import ar.com.wecoode.jitws.service.EstadoCivilService;
...
public class EstadoCivilController {
    ...
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/estadocivil";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/estadocivil";
    ...
    @Autowired
    EstadoCivilService elementoService;
    ...
    @ResponseBody
    public List<EstadoCivil> listarPorNombre(@PathVariable String nombre) {
        return elementoService.listarPorNombre(nombre);
    }
    
    //Agrega un registro
    @PostMapping(value = URL)
    public ResponseEntity<?> agregar(@RequestBody EstadoCivil elemento) {
        try {
            EstadoCivil e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody EstadoCivil elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody EstadoCivil elemento) {
        try {
