...
import ar.com.wecoode.jitws.service.AfipLocalidadService;
...
/**
 * Clase AfipLocalidad Controller
 * @author blas
 */

@RestController
public class AfipLocalidadController {
    
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/afiplocalidad";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/afiplocalidad";
    ...
    @Autowired
    AfipLocalidadService elementoService;
    ...
    public ResponseEntity<?> agregar(@RequestBody AfipLocalidad elemento) {
        try {
            AfipLocalidad e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody AfipLocalidad elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody AfipLocalidad elemento) {
        try {
