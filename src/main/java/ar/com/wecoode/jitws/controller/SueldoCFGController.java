...
import ar.com.wecoode.jitws.service.SueldoCFGService;
...
/**
 * Clase SueldoCFG Controller
 * @author blas
 */

@RestController
public class SueldoCFGController {
    
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/sueldocfg";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/sueldocfg";
    ...
    @Autowired
    SueldoCFGService elementoService;
    ...
    public ResponseEntity<?> agregar(@RequestBody SueldoCFG elemento) {
        try {
            SueldoCFG e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody SueldoCFG elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody SueldoCFG elemento) {
        try {
