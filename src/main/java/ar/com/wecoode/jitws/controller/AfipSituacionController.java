...
import ar.com.wecoode.jitws.service.AfipSituacionService;
...
/**
 * Clase AfipSituacion Controller
 * @author blas
 */
...
public class AfipSituacionController {
    ...
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/afipsituacion";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/afipsituacion";
    ...
    @Autowired
    AfipSituacionService elementoService;
    ...
    @ResponseBody
    public List<AfipSituacion> listarPorNombre(@PathVariable String nombre) {
        return elementoService.listarPorNombre(nombre);
    }
    
    //Agrega un registro
    @PostMapping(value = URL)
    public ResponseEntity<?> agregar(@RequestBody AfipSituacion elemento) {
        try {
            AfipSituacion e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody AfipSituacion elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody AfipSituacion elemento) {
        try {
