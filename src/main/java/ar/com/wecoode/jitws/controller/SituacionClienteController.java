...
import ar.com.wecoode.jitws.service.SituacionClienteService;
...
/**
 * Clase SituacionCliente Controller
 * @author blas
 */

@RestController
public class SituacionClienteController {
    
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/situacioncliente";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/situacioncliente";
    ...
    @Autowired
    SituacionClienteService elementoService;
    ...
    @ResponseBody
    public List<SituacionCliente> listarPorNombre(@PathVariable String nombre) {
        return elementoService.listarPorNombre(nombre);
    }
    
    //Agrega un registro
    @PostMapping(value = URL)
    public ResponseEntity<?> agregar(@RequestBody SituacionCliente elemento) {
        try {
            SituacionCliente e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody SituacionCliente elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody SituacionCliente elemento) {
        try {
