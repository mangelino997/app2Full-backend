...
public class ContactoBancoController {
    ...
    @RequestMapping(value = URL + "/obtenerPorSucursalBanco/{idSucursalBanco}")
    @ResponseBody
    public ContactoBanco obtenerPorSucursalBanco(@PathVariable int idSucursalBanco) {
        return elementoService.obtenerPorSucursalBanco(idSucursalBanco);
    }
