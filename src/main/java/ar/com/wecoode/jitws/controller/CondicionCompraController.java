...
import ar.com.wecoode.jitws.service.CondicionCompraService;
...
public class CondicionCompraController {
    ...
    public ResponseEntity<?> agregar(@RequestBody CondicionCompra elemento) {
        try {
            CondicionCompra e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> eliminar(@RequestBody CondicionCompra elemento) {
        try {
