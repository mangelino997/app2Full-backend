...
import ar.com.wecoode.jitws.service.ViajeTarifaService;
...
/**
 * Clase ViajeTarifa Controller
 * @author blas
 */

@RestController
public class ViajeTarifaController {
    
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/viajetarifa";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/viajetarifa";
    ...
    @Autowired
    ViajeTarifaService elementoService;
    ...
    public ResponseEntity<?> agregar(@RequestBody ViajeTarifa elemento) {
        try {
            ViajeTarifa e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody ViajeTarifa elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody ViajeTarifa elemento) {
        try {
