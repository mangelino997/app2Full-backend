...
import ar.com.wecoode.jitws.service.ViajeTerceroInsumoService;
...
/**
 * Clase ViajeTerceroInsumo Controller
 * @author blas
 */

@RestController
public class ViajeTerceroInsumoController {
    
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/viajeterceroinsumo";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/viajeterceroinsumo";
    ...
    @Autowired
    ViajeTerceroInsumoService elementoService;
    ...
    public ResponseEntity<?> agregar(@RequestBody ViajeTerceroInsumo elemento) {
        try {
            ViajeTerceroInsumo e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody ViajeTerceroInsumo elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody ViajeTerceroInsumo elemento) {
        try {
