...
import ar.com.wecoode.jitws.service.ViajePropioPeajeService;
...
/**
 * Clase ViajePropioPeaje Controller
 * @author blas
 */

@RestController
public class ViajePropioPeajeController {
    
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/viajepropiopeaje";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/pviajepropiopeajeais";
    ...
    @Autowired
    ViajePropioPeajeService elementoService;
    ...
    public ResponseEntity<?> agregar(@RequestBody ViajePropioPeaje elemento) {
        try {
            ViajePropioPeaje e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody ViajePropioPeaje elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody ViajePropioPeaje elemento) {
        try {
