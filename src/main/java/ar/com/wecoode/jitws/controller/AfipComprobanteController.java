...
import ar.com.wecoode.jitws.service.AfipComprobanteService;
...
/**
 * Clase AfipComprobante Controller
 * @author blas
 */

@RestController
public class AfipComprobanteController {
    
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/afipcomprobante";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/afipcomprobante";
    ...
    @Autowired
    AfipComprobanteService elementoService;
    ...
    public ResponseEntity<?> agregar(@RequestBody AfipComprobante elemento) {
        try {
            AfipComprobante e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody AfipComprobante elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody AfipComprobante elemento) {
        try {
