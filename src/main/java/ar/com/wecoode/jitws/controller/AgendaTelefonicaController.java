...
import ar.com.wecoode.jitws.service.AgendaTelefonicaService;
...
/**
 * Clase AgendaTelefonica Controller
 * @author blas
 */
...
public class AgendaTelefonicaController {
    ...
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/agendatelefonica";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/agendatelefonica";
    ...
    @Autowired
    AgendaTelefonicaService elementoService;
    ...
    @ResponseBody
    public List<AgendaTelefonica> listarPorNombre(@PathVariable String nombre) {
        return elementoService.listarPorNombre(nombre);
    }
    
    //Agrega un registro
    @PostMapping(value = URL)
    public ResponseEntity<?> agregar(@RequestBody AgendaTelefonica elemento) {
        try {
            AgendaTelefonica e = elementoService.agregar(elemento);
            ...
            if(partes[3].equals(DuplicidadError.CORREOELECTRONICO_UNICO)) {
    ...
    public ResponseEntity<?> actualizar(@RequestBody AgendaTelefonica elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody AgendaTelefonica elemento) {
        try {
