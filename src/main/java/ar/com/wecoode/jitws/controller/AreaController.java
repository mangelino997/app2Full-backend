...
import ar.com.wecoode.jitws.service.AreaService;
...
public class AreaController {
    ...
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/area";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/area";
    ...
    @ResponseBody
    public List<Area> listarPorNombre(@PathVariable String nombre) {
        return elementoService.listarPorNombre(nombre);
    }
    
    //Agrega un registro
    @PostMapping(value = URL)
    public ResponseEntity<?> agregar(@RequestBody Area elemento) {
        try {
            Area e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody Area elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody Area elemento) {
        try {
