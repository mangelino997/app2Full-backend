...
import ar.com.wecoode.jitws.service.ViajeUnidadNegocioService;
...
public class ViajeUnidadNegocioController {
    ...
    public ResponseEntity<?> agregar(@RequestBody ViajeUnidadNegocio elemento) {
        try {
            ViajeUnidadNegocio e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> eliminar(@RequestBody ViajeUnidadNegocio elemento) {
        try {
