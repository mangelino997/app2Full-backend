...
import ar.com.wecoode.jitws.service.SucursalClienteService;
...
public class SucursalClienteController {
    ...
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/sucursalcliente";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/sucursalcliente";
    ...
    @Autowired
    SucursalClienteService elementoService;
    ...
    @RequestMapping(value = URL + "/listarPorCliente/{idCliente}")
    @ResponseBody
