...
import ar.com.wecoode.jitws.service.UnidadMedidaService;
...
public class UnidadMedidaController {
    ...
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/unidadmedida";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/unidadmedida";
    ...
    @Autowired
    UnidadMedidaService elementoService;
    ...
    @ResponseBody
    public List<UnidadMedida> listarPorNombre(@PathVariable String nombre) {
        return elementoService.listarPorNombre(nombre);
    }
    
    //Agrega un registro
    @PostMapping(value = URL)
    public ResponseEntity<?> agregar(@RequestBody UnidadMedida elemento) {
        try {
            UnidadMedida e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody UnidadMedida elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody UnidadMedida elemento) {
        try {
