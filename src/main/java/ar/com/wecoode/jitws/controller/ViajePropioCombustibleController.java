...
import ar.com.wecoode.jitws.service.ViajePropioCombustibleService;
...
/**
 * Clase ViajePropioCombustible Controller
 * @author blas
 */

@RestController
public class ViajePropioCombustibleController {
    
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/viajepropiocombustible";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/viajepropiocombustible";
    ...
    @Autowired
    ViajePropioCombustibleService elementoService;
    ...
    public ResponseEntity<?> agregar(@RequestBody ViajePropioCombustible elemento) {
        try {
            ViajePropioCombustible e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody ViajePropioCombustible elemento) {
        try {
