...
import ar.com.wecoode.jitws.service.ViajePrecioService;
...
public class ViajePrecioController {
    ...
    @RequestMapping(value = URL + "/obtenerCosto/{idViajeTipo}/{idViajeTarifa}")
    @ResponseBody
    ...
    public ResponseEntity<?> agregar(@RequestBody ViajePrecio elemento) {
        try {
            ViajePrecio e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> eliminar(@RequestBody ViajePrecio elemento) {
        try {
