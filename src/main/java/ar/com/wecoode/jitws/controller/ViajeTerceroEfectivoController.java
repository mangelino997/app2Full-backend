...
import ar.com.wecoode.jitws.service.ViajeTerceroEfectivoService;
...
/**
 * Clase ViajeTerceroEfectivo Controller
 * @author blas
 */

@RestController
public class ViajeTerceroEfectivoController {
    
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/viajeterceroefectivo";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/viajeterceroefectivo";
    ...
    @Autowired
    ViajeTerceroEfectivoService elementoService;
    ...
    public ResponseEntity<?> agregar(@RequestBody ViajeTerceroEfectivo elemento) {
        try {
            ViajeTerceroEfectivo e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody ViajeTerceroEfectivo elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody ViajeTerceroEfectivo elemento) {
        try {
