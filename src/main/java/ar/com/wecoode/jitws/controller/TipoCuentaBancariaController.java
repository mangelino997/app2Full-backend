...
import ar.com.wecoode.jitws.service.TipoCuentaBancariaService;
...
/**
 * Clase TipoCuentaBancaria Controller
 * @author blas
 */
...
public class TipoCuentaBancariaController {
    ...
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/tipocuentabancaria";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/tipocuentabancaria";
    ...
    @Autowired
    TipoCuentaBancariaService elementoService;
    ...
    @ResponseBody
    public List<TipoCuentaBancaria> listarPorNombre(@PathVariable String nombre) {
        return elementoService.listarPorNombre(nombre);
    }
    
    //Agrega un registro
    @PostMapping(value = URL)
    public ResponseEntity<?> agregar(@RequestBody TipoCuentaBancaria elemento) {
        try {
            TipoCuentaBancaria e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody TipoCuentaBancaria elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody TipoCuentaBancaria elemento) {
        try {
