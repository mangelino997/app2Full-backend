...
import ar.com.wecoode.jitws.service.UsuarioService;
...
public class UsuarioController {
    ...
    public ResponseEntity<?> agregar(@RequestBody Usuario elemento) {
        try {
            Usuario e = elementoService.agregar(elemento);
            ...
            if(partes[3].equals(DuplicidadError.USERNAME_UNICO)) {
                ...
                return new ResponseEntity(new EstadoRespuesta(CodigoRespuesta.DATO_DUPLICADO_USERNAME, 
                    MensajeRespuesta.DATO_DUPLICADO + " '" + elemento.getUsername() + "'"), 
