...
import ar.com.wecoode.jitws.service.ViajeTerceroTramoClienteService;
...
/**
 * Clase ViajeTerceroTramoCliente Controller
 * @author blas
 */

@RestController
public class ViajeTerceroTramoClienteController {
    
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/viajetercerotramocliente";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/viajetercerotramocliente";
    ...
    @Autowired
    ViajeTerceroTramoClienteService elementoService;
    ...
    public ResponseEntity<?> agregar(@RequestBody ViajeTerceroTramoCliente elemento) {
        try {
            ViajeTerceroTramoCliente e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody ViajeTerceroTramoCliente elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody ViajeTerceroTramoCliente elemento) {
        try {
