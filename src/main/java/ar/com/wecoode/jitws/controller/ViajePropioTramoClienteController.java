...
import ar.com.wecoode.jitws.service.ViajePropioTramoClienteService;
...
/**
 * Clase ViajePropioTramoCliente Controller
 * @author blas
 */

@RestController
public class ViajePropioTramoClienteController {
    
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/viajepropiotramocliente";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/viajepropiotramocliente";
    ...
    @Autowired
    ViajePropioTramoClienteService elementoService;
    ...
    public ResponseEntity<?> agregar(@RequestBody ViajePropioTramoCliente elemento) {
        try {
            ViajePropioTramoCliente e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody ViajePropioTramoCliente elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody ViajePropioTramoCliente elemento) {
        try {
