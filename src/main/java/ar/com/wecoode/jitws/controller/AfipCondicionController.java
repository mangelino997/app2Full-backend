...
import ar.com.wecoode.jitws.service.AfipCondicionService;
...
/**
 * Clase AfipCondicion Controller
 * @author blas
 */

@RestController
public class AfipCondicionController {
    
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/afipcondicion";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/afipcondicion";
    ...
    @Autowired
    AfipCondicionService elementoService;
    ...
    @ResponseBody
    public List<AfipCondicion> listarPorNombre(@PathVariable String nombre) {
        return elementoService.listarPorNombre(nombre);
    }
    
    //Agrega un registro
    @PostMapping(value = URL)
    public ResponseEntity<?> agregar(@RequestBody AfipCondicion elemento) {
        try {
            AfipCondicion e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody AfipCondicion elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody AfipCondicion elemento) {
        try {
