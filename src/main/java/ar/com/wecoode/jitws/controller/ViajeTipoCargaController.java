...
import ar.com.wecoode.jitws.service.ViajeTipoCargaService;
...
/**
 * Clase ViajeTipoCarga Controller
 * @author blas
 */

@RestController
public class ViajeTipoCargaController {
    
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/viajetipocarga";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/viajetipocarga";
    ...
    @Autowired
    ViajeTipoCargaService elementoService;
    ...
    @ResponseBody
    public List<ViajeTipoCarga> listarPorNombre(@PathVariable String nombre) {
        return elementoService.listarPorNombre(nombre);
    }
    
    //Agrega un registro
    @PostMapping(value = URL)
    public ResponseEntity<?> agregar(@RequestBody ViajeTipoCarga elemento) {
        try {
            ViajeTipoCarga e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody ViajeTipoCarga elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody ViajeTipoCarga elemento) {
        try {
