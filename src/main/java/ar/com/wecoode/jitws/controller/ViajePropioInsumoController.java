...
import ar.com.wecoode.jitws.service.ViajePropioInsumoService;
...
public class ViajePropioInsumoController {
    ...
    public ResponseEntity<?> agregar(@RequestBody ViajePropioInsumo elemento) {
        try {
            ViajePropioInsumo e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> eliminar(@RequestBody ViajePropioInsumo elemento) {
        try {
