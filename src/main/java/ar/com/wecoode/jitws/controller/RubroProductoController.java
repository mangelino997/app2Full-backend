...
import ar.com.wecoode.jitws.service.RubroProductoService;
...
/**
 * Clase RubroProducto Controller
 * @author blas
 */
...
public class RubroProductoController {
    ...
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/rubroproducto";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/rubroproducto";
    ...
    @ResponseBody
    public List<RubroProducto> listarPorNombre(@PathVariable String nombre) {
        return elementoService.listarPorNombre(nombre);
    }
    
    //Agrega un registro
    @PostMapping(value = URL)
    public ResponseEntity<?> agregar(@RequestBody RubroProducto elemento) {
        try {
            RubroProducto e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody RubroProducto elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody RubroProducto elemento) {
        try {
