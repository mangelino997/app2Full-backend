...
import ar.com.wecoode.jitws.service.AfipModContratacionService;
...
/**
 * Clase AfipModContratacion Controller
 * @author blas
 */

@RestController
public class AfipModContratacionController {
    
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/afipmodcontratacion";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/afipmodcontratacion";
    ...
    @Autowired
    AfipModContratacionService elementoService;
    ...
    @ResponseBody
    public List<AfipModContratacion> listarPorNombre(@PathVariable String nombre) {
        return elementoService.listarPorNombre(nombre);
    }
    
    //Agrega un registro
    @PostMapping(value = URL)
    public ResponseEntity<?> agregar(@RequestBody AfipModContratacion elemento) {
        try {
            AfipModContratacion e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody AfipModContratacion elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody AfipModContratacion elemento) {
        try {
