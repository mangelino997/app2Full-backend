...
import ar.com.wecoode.jitws.service.OrigenDestinoService;
...
/**
 * Clase OrigenDestino Controller
 * @author blas
 */
...
public class OrigenDestinoController {
    ...
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/origendestino";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/origendestino";
    ...
    public ResponseEntity<?> agregar(@RequestBody OrigenDestino elemento) {
        try {
            OrigenDestino e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody OrigenDestino elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody OrigenDestino elemento) {
        try {
