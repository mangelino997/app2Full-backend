...
import ar.com.wecoode.jitws.service.ViajePropioEfectivoService;
...
public class ViajePropioEfectivoController {
    ...
    public ResponseEntity<?> agregar(@RequestBody ViajePropioEfectivo elemento) {
        try {
            ViajePropioEfectivo e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> eliminar(@RequestBody ViajePropioEfectivo elemento) {
        try {
