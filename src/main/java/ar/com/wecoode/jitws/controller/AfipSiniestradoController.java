...
import ar.com.wecoode.jitws.service.AfipSiniestradoService;
...
/**
 * Clase AfipSiniestrado Controller
 * @author blas
 */

@RestController
public class AfipSiniestradoController {
    
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/afipsiniestrado";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/afipsiniestrado";
    ...
    @Autowired
    AfipSiniestradoService elementoService;
    ...
    public ResponseEntity<?> agregar(@RequestBody AfipSiniestrado elemento) {
        try {
            AfipSiniestrado e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody AfipSiniestrado elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody AfipSiniestrado elemento) {
        try {
