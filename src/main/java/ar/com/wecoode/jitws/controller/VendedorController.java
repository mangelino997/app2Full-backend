...
import ar.com.wecoode.jitws.service.VendedorService;
...
public class VendedorController {
    ...
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/vendedor";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/vendedor";
    ...
    @Autowired
    VendedorService elementoService;
    ...
    @ResponseBody
    public List<Vendedor> listarPorNombre(@PathVariable String nombre) {
        return elementoService.listarPorNombre(nombre);
    }
    
    //Agrega un registro
    @PostMapping(value = URL)
    public ResponseEntity<?> agregar(@RequestBody Vendedor elemento) {
        try {
            Vendedor e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody Vendedor elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody Vendedor elemento) {
        try {
