...
import ar.com.wecoode.jitws.service.CategoriaService;
...
public class CategoriaController {
    ...
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/categoria";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/categoria";
    ...
    @Autowired
    CategoriaService elementoService;
    ...
    @ResponseBody
    public List<Categoria> listarPorNombre(@PathVariable String nombre) {
        return elementoService.listarPorNombre(nombre);
    }
    
    //Agrega un registro
    @PostMapping(value = URL)
    public ResponseEntity<?> agregar(@RequestBody Categoria elemento) {
        try {
            Categoria e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody Categoria elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody Categoria elemento) {
        try {
