...
import ar.com.wecoode.jitws.service.MarcaVehiculoService;
...
public class MarcaVehiculoController {
    ...
    public ResponseEntity<?> agregar(@RequestBody MarcaVehiculo elemento) {
        try {
            MarcaVehiculo e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> eliminar(@RequestBody MarcaVehiculo elemento) {
        try {
