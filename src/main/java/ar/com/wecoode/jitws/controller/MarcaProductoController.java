...
import ar.com.wecoode.jitws.service.MarcaProductoService;
...
public class MarcaProductoController {
    ...
    public ResponseEntity<?> agregar(@RequestBody MarcaProducto elemento) {
        try {
            MarcaProducto e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> eliminar(@RequestBody MarcaProducto elemento) {
        try {
