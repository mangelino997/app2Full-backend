...
import ar.com.wecoode.jitws.service.TipoVehiculoService;
...
public class TipoVehiculoController {
    ...
    public ResponseEntity<?> agregar(@RequestBody TipoVehiculo elemento) {
        try {
            TipoVehiculo e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> eliminar(@RequestBody TipoVehiculo elemento) {
        try {
