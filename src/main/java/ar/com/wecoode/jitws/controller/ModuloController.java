...
import ar.com.wecoode.jitws.service.ModuloService;
...
public class ModuloController {
    ...
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/modulo";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/modulo";
    ...
    @ResponseBody
    public List<Modulo> listarPorNombre(@PathVariable String nombre) {
        return elementoService.listarPorNombre(nombre);
    }
    
    //Agrega un registro
    @PostMapping(value = URL)
    public ResponseEntity<?> agregar(@RequestBody Modulo elemento) {
        try {
            Modulo e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody Modulo elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody Modulo elemento) {
        try {
