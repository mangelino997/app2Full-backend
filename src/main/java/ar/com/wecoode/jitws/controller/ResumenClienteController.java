...
import ar.com.wecoode.jitws.service.ResumenClienteService;
...
/**
 * Clase ResumenCliente Controller
 * @author blas
 */
...
public class ResumenClienteController {
    ...
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/resumencliente";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/resumencliente";
    ...
    @Autowired
    ResumenClienteService elementoService;
    ...
    @ResponseBody
    public List<ResumenCliente> listarPorNombre(@PathVariable String nombre) {
        return elementoService.listarPorNombre(nombre);
    }
    
    //Agrega un registro
    @PostMapping(value = URL)
    public ResponseEntity<?> agregar(@RequestBody ResumenCliente elemento) {
        try {
            ResumenCliente e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody ResumenCliente elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody ResumenCliente elemento) {
        try {
