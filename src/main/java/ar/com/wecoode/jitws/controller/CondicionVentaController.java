...
import ar.com.wecoode.jitws.service.CondicionVentaService;
...
public class CondicionVentaController {
    ...
    public ResponseEntity<?> agregar(@RequestBody CondicionVenta elemento) {
        try {
            CondicionVenta e = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> eliminar(@RequestBody CondicionVenta elemento) {
        try {
