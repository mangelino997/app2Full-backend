...
import ar.com.wecode.jitws.model.ContactoCompaniaSeguro;
...
public interface IContactoCompaniaSeguroDAO extends JpaRepository<ContactoCompaniaSeguro, Integer> {
    ...
    @Query(value = "SELECT * FROM contactocompaniaseguro b WHERE b.nombre like %:nom%", nativeQuery = true)
    public List<ContactoCompaniaSeguro> listarPorNombre(@Param("nom") String nom);
