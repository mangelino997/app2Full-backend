...
import ar.com.wecode.jitws.model.ViajePropioPeaje;
...
public interface IViajePropioPeajeDAO extends JpaRepository<ViajePropioPeaje, Integer> {
    ...
    public final String NOMBRE_TABLA = "viajepropiopeaje";
    ...
    public List<ViajePropioPeaje> findByViajePropio(Optional<ViajePropio> viajePropio);
