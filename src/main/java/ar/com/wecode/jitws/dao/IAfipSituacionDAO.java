...
public interface IAfipSituacionDAO extends JpaRepository<AfipSituacion, Integer> {
    ...
    public final String NOMBRE_TABLA = "afipsituacion";
    ...
    @Query(value = "SELECT * FROM afipsituacion b WHERE b.nombre like %:nom%", nativeQuery = true)
    public List<AfipSituacion> listarPorNombre(@Param("nom") String nom);
