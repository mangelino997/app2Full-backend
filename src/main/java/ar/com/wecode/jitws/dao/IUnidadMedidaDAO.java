...
import ar.com.wecode.jitws.model.UnidadMedida;
...
public interface IUnidadMedidaDAO extends JpaRepository<UnidadMedida, Integer> {
    ...
    @Query(value = "SELECT * FROM unidadmedida b WHERE b.nombre like %:nom%", nativeQuery = true)
    public List<UnidadMedida> listarPorNombre(@Param("nom") String nom);
