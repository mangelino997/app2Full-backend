...
/**
 * Interfaz DAO VentaTipoItem Define los metodos particulares contra la base de
 * datos
 *
 * @author blas
 */
public interface IVentaTipoItemDAO extends JpaRepository<VentaTipoItem, Integer> {
    ...
    @Query(value = "SELECT * FROM ventatipoitem where idTipoComprobante = :idTipoComprobante and estaHabilitado = 1",
            nativeQuery = true)
