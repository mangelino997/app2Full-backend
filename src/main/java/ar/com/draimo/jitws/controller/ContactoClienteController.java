...
import ar.com.draimo.jitws.service.ContactoClienteService;
...
public class ContactoClienteController {
    ...
    @ResponseBody
    public List<ContactoCliente> listarPorCliente(@PathVariable int idCliente) {
    ...
    public ResponseEntity<?> agregar(@RequestBody ContactoCliente elemento) {
        try {
            ContactoCliente a = elementoService.agregar(elemento);
