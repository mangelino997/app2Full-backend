...
/**
 * Clase ChequeController
 *
 * @author blas
 */
@RestController
public class ChequeCarteraController {

    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/chequecartera";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/chequecartera";
    ...
    @Autowired
    ChequeCarteraService elementoService;
    ...
    @ResponseBody
    public List<ChequeCartera> listarPorEmpresa(@PathVariable int idEmpresa) {
    ...
    public ResponseEntity<?> agregar(@RequestBody ChequeCartera elemento) {
        try {
            ChequeCartera a = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody ChequeCartera elemento) {
        try {
