...
import ar.com.draimo.jitws.service.ViajePropioService;
...
/**
 * Clase ViajePropio Controller
 * @author blas
 */

@RestController
public class ViajePropioController {
    
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/viajepropio";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/viajepropio";
    ...
    public ResponseEntity<?> agregar(@RequestBody ViajePropio elemento) {
        try {
            ViajePropio a = elementoService.agregar(elemento);
...
//            template.convertAndSend(TOPIC + "/lista", elementoService.listar());
    ...
    public ResponseEntity<?> eliminar(@RequestBody ViajePropio elemento) {
        try {
