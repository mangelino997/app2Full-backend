...
import ar.com.draimo.jitws.service.ViajePropioGastoService;
...
public class ViajePropioGastoController {
    ...
    @GetMapping(value = URL + "/listarGastos/{idViajePropio}")
    @ResponseBody
    public List<ViajePropioGasto> listarGastos(@PathVariable int idViajePropio) {
        return elementoService.listarGastos(idViajePropio);
    }
    ...
    public ResponseEntity<?> agregar(@RequestBody ViajePropioGasto elemento) {
        try {
            ViajePropioGasto a = elementoService.agregar(elemento);
