...
import ar.com.draimo.jitws.service.MedioPagoService;
...
public class MedioPagoController {
    ...
    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/mediopago";

    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/mediopago";
    ...
    @Autowired
    MedioPagoService elementoService;
    ...
    @ResponseBody
    public List<MedioPago> listarPorNombre(@PathVariable String nombre) {
    ...
    public ResponseEntity<?> agregar(@RequestBody MedioPago elemento) {
        try {
            MedioPago a = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody MedioPago elemento) {
        try {
