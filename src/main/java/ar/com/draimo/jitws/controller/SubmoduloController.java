...
import ar.com.draimo.jitws.service.SubmoduloService;
...
public class SubmoduloController {
    ...
    private final String TOPIC = RutaConstant.URL_TOPIC + "/submodulo";
    ...
    @GetMapping(value = URL + "/listarPorModulo/{idModulo}")
    @ResponseBody
    ...
    public ResponseEntity<?> agregar(@RequestBody Submodulo elemento) {
        try {
            Submodulo a = elementoService.agregar(elemento);
