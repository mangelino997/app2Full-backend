...
public class PdfController {
    ...
    @ResponseBody
    public Pdf obtenerPorId(@PathVariable int id) {
    ...
    @ResponseBody
    public List<Pdf> listarPorNombre(@PathVariable String nombre) {
        return elementoService.listarPorNombre(nombre);
    }
    
    //Agrega un registro
    @PostMapping(value = URL)
    public ResponseEntity<?> agregar(@RequestBody Pdf elemento) {
        try {
            Pdf a = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody Pdf elemento) {
        try {
    ...
    public ResponseEntity<?> eliminar(@RequestBody Pdf elemento) {
        try {
