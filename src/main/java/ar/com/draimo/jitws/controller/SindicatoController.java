...
import ar.com.draimo.jitws.service.SindicatoService;
...
public class SindicatoController {
    ...
    private final String TOPIC = RutaConstant.URL_TOPIC + "/sindicato";
    ...
    public ResponseEntity<?> agregar(@RequestBody Sindicato elemento) {
        try {
            Sindicato a = elementoService.agregar(elemento);
