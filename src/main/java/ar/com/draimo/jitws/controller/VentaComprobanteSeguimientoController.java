...
public class VentaComprobanteSeguimientoController {
    ...
    @ResponseBody
    public List<VentaComprobanteSeguimiento> listarPorVentaComprobante(@PathVariable int idVentaComprobante) {
    ...
    @ResponseBody
    public List<VentaComprobanteSeguimiento> listarPorSeguimientoEstado(@PathVariable int idSeguimientoEstado) {
        return elementoService.listarPorSeguimientoEstado(idSeguimientoEstado);
    }
    
    //Agrega un registro
    @PostMapping(value = URL)
    public ResponseEntity<?> agregar(@RequestBody VentaComprobanteSeguimiento elemento) {
        try {
            VentaComprobanteSeguimiento a = elementoService.agregar(elemento);
...
//            template.convertAndSend(TOPIC + "/lista", elementoService.listar());
    ...
    public ResponseEntity<?> actualizar(@RequestBody VentaComprobanteSeguimiento elemento) {
        try {
