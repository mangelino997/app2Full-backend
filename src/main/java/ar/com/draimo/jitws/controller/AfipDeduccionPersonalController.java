...
/**
 * Clase AfipDeduccionPersonal Controller
 *
 * @author blas
 */
@RestController
public class AfipDeduccionPersonalController {

    //Define la url
    private final String URL = RutaConstant.URL_BASE + "/afipdeduccionpersonal";
    //Define la url de subcripciones a sockets
    private final String TOPIC = RutaConstant.URL_TOPIC + "/afipdeduccionpersonal";
    ...
    @ResponseBody
    public InitDeduccionPersonalTablaDTO inicializar(@PathVariable int idRol, @PathVariable int idSubopcion) {
    ...
    @ResponseBody
    public List<AfipDeduccionPersonal> listarPorDescripcion(@PathVariable String descripcion) {
        return elementoService.listarPorDescripcion(descripcion);
    }

    //Agrega un registro
    @PostMapping(value = URL)
    public ResponseEntity<?> agregar(@RequestBody AfipDeduccionPersonal elemento) {
        try {
            AfipDeduccionPersonal a = elementoService.agregar(elemento);
    ...
    public ResponseEntity<?> actualizar(@RequestBody AfipDeduccionPersonal elemento) {
        try {
