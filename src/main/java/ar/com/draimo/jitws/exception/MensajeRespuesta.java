...
public class MensajeRespuesta {
    ...
    public static final String LONGITUD = "Cantidad caracteres excedida";
    ...
    public static final String EXISTENTE = "Registro existente";
    ...
    //Retorna mensaje de registro existente
    public static ResponseEntity<?> registroExistente() {
        return new ResponseEntity(new EstadoRespuesta(CodigoRespuesta.NO_EXISTENTE,
                MensajeRespuesta.EXISTENTE, 0), HttpStatus.INTERNAL_SERVER_ERROR);
    }
                ...
                if (parte3[1].equals("truncation:")) {
                    ...
                    switch (partes[1]) {
                        ...
                        case LongitudError.DESCRIPCION_LONGITUD:
                            ...
                            break;
                        case LongitudError.DESCRIPCION_CARGA_LONGITUD:
                            codigoRespuesta = CodigoRespuesta.DESCRIPCION_CARGA_LONGITUD;
                            plusMensaje = ": DESCRIPCION CARGA";
                            break;
    ...
    public static ResponseEntity<?> datoInexistente(String a, String b) {
        ...
        switch (s) {
            ...
            case InexistenciaError.VIAJE_TRAMO_INEXISTENTE:
                ...
                plusMensaje = ": VIAJE TRAMO";
                break;
            case InexistenciaError.VIAJE_TRAMO_CLIENTE_INEXISTENTE:
                codigoRespuesta = CodigoRespuesta.VIAJE_TRAMO_CLIENTE_INEXISTENTE;
                plusMensaje = ": VIAJE TRAMO CLIENTE";
                break;
            case InexistenciaError.VIAJE_TRAMO_CLIENTE_REMITO_INEXISTENTE:
                codigoRespuesta = CodigoRespuesta.VIAJE_TRAMO_CLIENTE_REMITO_INEXISTENTE;
                plusMensaje = ": VIAJE TRAMO CLIENTE REMITO";
                break;
