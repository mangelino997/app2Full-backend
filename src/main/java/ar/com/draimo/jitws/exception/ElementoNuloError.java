...
public class ElementoNuloError {
    ...
    public static final String AFIP_ALICUOTA_GANANCIA_LONGITUD = "idAfipAlicuotaGanancia";
    public static final String AFIP_CONDICION_IVA_LONGITUD = "idAfipCondicionIva";
    public static final String AFIP_DEDUCCION_GENERAL_LONGITUD = "idAfipDeduccionGeneral";
    public static final String AFIP_DEDUCCION_PERSONAL_LONGITUD = "idAfipDeduccionPersonal";
    public static final String AFIP_TIPO_BENEFICIO_LONGITUD = "idAfipTipoBeneficio";
    public static final String CATEGORIA_LONGITUD = "idCategoria";
    public static final String CLIENTE_LONGITUD = "idCliente";
    public static final String COBRADOR_LONGITUD = "idCobrador";
    public static final String CONDICION_VENTA_LONGITUD = "idCondicionVenta";
    public static final String CUENTA_BANCARIA_LONGITUD = "idCuentaBancaria";
    public static final String EMPRESA_LONGITUD = "idEmpresa";
    public static final String LOCALIDAD_LONGITUD = "idLocalidad";
    public static final String MES_LONGITUD = "idMes";
    public static final String ORDEN_VENTA_LONGITUD = "idOrdenVenta";
    public static final String PROVEEDOR_LONGITUD = "idProveedor";
    public static final String QUINCENA_LONGITUD = "idQuincena";
    public static final String RUBRO_LONGITUD = "idRubro";
    public static final String TIPO_CHEQUERA_LONGITUD = "idTipoChequera";
    public static final String TIPO_COMPROBANTE_LONGITUD = "idTipoComprobante";
    public static final String TIPO_DOCUMENTO_LONGITUD = "idTipoDocumento";
    public static final String USUARIO_LONGITUD = "idUsuario";
    public static final String USUARIO_ALTA_LONGITUD = "idUsuarioAlta";
    public static final String USUARIO_BAJA_LONGITUD = "idUsuarioBaja";
    public static final String USUARIO_MOD_LONGITUD = "idUsuarioMod";
    public static final String ZONA_LONGITUD = "idZona";
    ...
    public static final String ANIO_LONGITUD = "anio";
    ...
    public static final String DIAS_LABORABLES_LONGITUD = "diasLaborables";
    ...
    public static final String ES_CUENTA_CORRIENTE_LONGITUD = "esCuentaCorriente";
    public static final String ES_RECEPTOR_FCE_LONGITUD = "esReceptorFCE";
    public static final String ES_SEGURO_PROPIO_LONGITUD = "esSeguroPropio";
    public static final String ESTA_ACTIVA_LONGITUD = "estaActiva";
    public static final String ESTA_ACTIVO_LONGITUD = "estaActivo";
    ...
    public static final String FECHA_SOLICITUD_LONGITUD = "fechaSolicitud";
    ...
    public static final String HORAS_LABORABLES_LONGITUD = "horasLaborables";
    public static final String IMPORTE_LONGITUD = "importe";
    public static final String IMPORTE_ANUAL_MENSUAL_LONGITUD = "importeAnualMensual";
    ...
    public static final String IMPRIMIR_CONTROL_DEUDA_LONGITUD = "imprimirControlDeuda";
    ...
    public static final String POR_DEFECTO_LONGITUD = "porDefecto";
    ...
    public static final String TAMANIO_LONGITUD = "tamanio";
